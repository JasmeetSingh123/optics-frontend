    ...
    <section className="relative w-full flex flex-1 justify-center items-center bg-white" >
      <div className="relative w-5/6 lg:w-3/4 py-8 sm:py-16" >
        ...
        <div className="flex flex-col justify-center items-center mt-8 sm:mt-10 md:mt-12 text-center" >
          <h1 className="app__landing-showcase-text text-[1.2rem] sm:text-[1.5rem] md:text-[2rem] font-bold text-center lg:w-2/3 xl:w-1/2" >Stylish eyeware designed in-house and crafted from the best materials.</h1>
          ...
          <Link to="comingsoon" className="flex items-center justify-center gap-3" >
